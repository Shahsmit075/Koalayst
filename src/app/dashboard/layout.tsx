...
import { Footprints, Github, User , Gem, Home, Key, LucideIcon, Menu, Settings, X } from "lucide-react"
...
const SIDEBAR_ITEMS: SidebarCategory[] = [
  {
    ...
    items: [
      ...
      { href: "/dashboard/steps", icon: Footprints, text: "Guide" },
...
const Sidebar = ({ onClose }: { onClose?: () => void }) => {
  return (
    <div className="space-y-4 md:space-y-6 relative z-20 flex flex-col h-full">
      ...
      <Link href="/" className="flex items-center z-40 font-bold">
        <img 
